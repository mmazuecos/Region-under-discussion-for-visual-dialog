...
from utils.datasets.Oracle.OracleVisualDataset1 import OracleVisualDataset1 as OracleVisualDataset
...
if __name__ == '__main__':
    ...
    for sample in tqdm(dataloader):
        ...
        #    break
        # Get question
        questions, answers, crop_features, visual_features, spatials, obj_categories, lengths, game_id= \
            sample['question'], sample['answer'], sample['crop_features'], sample['img_features'], sample['spatial'], sample['obj_cat'], sample['length'], sample['game_id']
        ...
        #print(questions, answers, crop_features, visual_features, spatials, obj_categories, lengths, game_id)
