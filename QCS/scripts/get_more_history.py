...
rules = [
    ...
    ('is_a',   pref + '(?:an?_DT|one_CD of_IN the_DT) (?P<val1>\w+)_NN(?:S|P|PS)? (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ('is_the', pref + 'the_DT (?P<val1>\w+)_NN(?:S|P|PS)? (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ('in_a',   pref + '(?:the_DT one_NN )?in_IN (?:an?_DT|one_CD of_IN the_DT) (?P<val1>\w+)_NN(?:S|P|PS)? (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ('in_the', pref + '(?:the_DT one_NN )?in_IN the_DT (?P<val1>\w+)_NN(?:S|P|PS)? (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ('on_a',   pref + '(?:the_DT one_NN )?on_IN (?:an?_DT|one_CD of_IN the_DT) (?P<val1>\w+)_NN(?:S|P|PS)? (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ('on_the', pref + '(?:the_DT one_NN )?on_IN the_DT (?P<val1>\w+)_NN(?:S|P|PS)? (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ...
    ('in_a',   pref + '(?:the_DT one_NN )?in_IN (?:an?_DT|one_CD of_IN the_DT) (?P<val1>\w+)_JJ (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ('in_the', pref + '(?:the_DT one_NN )?in_IN the_DT (?P<val1>\w+)_JJ (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ('on_a',   pref + '(?:the_DT one_NN )?on_IN (?:an?_DT|one_CD of_IN the_DT) (?P<val1>\w+)_JJ (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
    ('on_the', pref + '(?:the_DT one_NN )?on_IN the_DT (?P<val1>\w+)_JJ (?P<val2>\w+)_NN(?:S|P|PS)?' + suf),
